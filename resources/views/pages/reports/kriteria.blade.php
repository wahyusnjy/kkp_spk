    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-gray-400 text-lg">Download laporan detail semua kriteria dengan statistik penggunaan</p>
            </div>
            ...
            <div class="bg-gray-800 rounded-2xl shadow-2xl border border-gray-700 overflow-hidden">
                <div class="p-8">
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-400">Pilih format file yang diinginkan untuk download laporan</p>
                    </div>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {{-- PDF Export --}}
                        <a href="{{ route('reports.kriteria', ['format' => 'pdf']) }}" 
                        ...
                        {{-- Excel Export --}}
                        <a href="{{ route('reports.kriteria', ['format' => 'excel']) }}" 
                    ...
                    <div class="mt-8 p-6 bg-blue-900/20 border border-blue-700/30 rounded-xl">
                        ...
                        <ul class="text-gray-300 text-sm space-y-2">
                            <li class="flex items-start gap-2">
                                ...
                                <span>Detail lengkap semua kriteria (nama, tipe, bobot, keterangan)</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <i class="fas fa-check text-green-400 mt-1"></i>
                                <span>Statistik penggunaan kriteria di assessment</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <i class="fas fa-check text-green-400 mt-1"></i>
                                <span>Rata-rata, maksimum, dan minimum score per kriteria</span>
                            </li>
                            <li class="flex items-start gap-2">
                                <i class="fas fa-check text-green-400 mt-1"></i>
                                <span>Ringkasan total kriteria benefit vs cost</span>
                            </li>
                        </ul>
                    </div>
                </div>
