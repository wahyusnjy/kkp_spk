    <x-layouts.app :title="__('Tambah Kriteria')">
        <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl">
            <!-- Header Section -->
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 class="text-2xl font-bold text-white">Tambah KRITERIA KONNSS Baru</h1>
                    <p class="text-gray-400 mt-1">Buat kriteria penilaian untuk sistem evaluasi supplier</p>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-dark-300 rounded-xl border border-dark-200 p-6">
                        ...
                        <form id="kriteriaFormCreate" method="POST" action="{{ route('kriteria.store') }}">
                            @csrf
                            <div class="space-y-6">
                                <!-- Nama Kriteria -->
                                ...
                                <div class="bg-dark-400/50 rounded-lg p-4 border border-dark-200">
                                    ...
                                    <textarea id="keterangan" name="keterangan" rows="3"
                                            ...
                                            placeholder="Jelaskan detail kriteria penilaian...">{{ old('keterangan') }}</textarea>
